      ...
      children: [
        ...
        IntrinsicHeight(
          child: Row(
            ...
            children: [
              Expanded(
                child: _buildCard(Icons.person, "PERSONNEL", detail.personnel),
              ),
              const SizedBox(width: 15),
              Expanded(
                child: _buildCard(Icons.payments, "TOTAL COST", detail.cost),
              ),
            ],
          ),
        ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color.fromARGB(
                ...
                255,
                255,
              ).withOpacity(0.12), // Very light blue circular background
